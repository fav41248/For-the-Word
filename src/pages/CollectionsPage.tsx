...
import { Heart, ShoppingBag, Loader2, Ruler } from 'lucide-react';
...
export const PRODUCTS: Product[] = [
  { id: '1', name: 'Redeemed Culture Tee', scripture: 'Isaiah 55:11', price: 15000, priceDisplay: '₦15,000', category: 'T-Shirts', volume: 'Volume I', color: '#567C8D', isNew: true, image: '/redeemed.png' },
  { id: '2', name: 'Isaiah 55:11 Hoodie', scripture: 'Isaiah 55:11', price: 28000, priceDisplay: '₦28,000', category: 'Hoodies', volume: 'Volume I', color: '#567C8D', image: 'https://images.unsplash.com/photo-1556821840-3a63f95609a7?q=80&w=800&auto=format&fit=crop' },
  { id: '3', name: 'Salt & Light Tee', scripture: 'Matthew 5:13-16', price: 15000, priceDisplay: '₦15,000', category: 'T-Shirts', volume: 'Volume II', color: '#3A5A6B', image: '/salt-light.png' },
  { id: '4', name: 'Walk By Faith Cap', scripture: '2 Corinthians 5:7', price: 10000, priceDisplay: '₦10,000', category: 'Caps', volume: 'Volume II', color: '#3A5A6B', isNew: true, image: '/walk-by-faith.png' },
  { id: '5', name: 'Romans 12:2 Tee', scripture: 'Romans 12:2', price: 15000, priceDisplay: '₦15,000', category: 'T-Shirts', volume: 'Volume III', color: '#1A1A2E', image: 'https://images.unsplash.com/photo-1576566588028-4147f3842f27?q=80&w=800&auto=format&fit=crop' },
  { id: '6', name: 'Romans 12:2 Hoodie', scripture: 'Romans 12:2', price: 28000, priceDisplay: '₦28,000', category: 'Hoodies', volume: 'Volume III', color: '#1A1A2E', image: 'https://images.unsplash.com/photo-1509942774463-acf339cf87d5?q=80&w=800&auto=format&fit=crop' },
  { id: '7', name: 'FTW Logo Tee', scripture: 'Core Collection', price: 12000, priceDisplay: '₦12,000', category: 'T-Shirts', volume: 'Core', color: '#C8D9E6', image: 'https://images.unsplash.com/photo-1529374255404-311a2a4f1fd9?q=80&w=800&auto=format&fit=crop' },
  { id: '8', name: 'FTW Scripture Cap', scripture: 'Core Collection', price: 10000, priceDisplay: '₦10,000', category: 'Caps', volume: 'Core', color: '#C8D9E6', image: 'https://images.unsplash.com/photo-1556306535-0f09a537f0a3?q=80&w=800&auto=format&fit=crop' },
];
        ...
        <div className="flex flex-wrap gap-3">
          {FILTERS.map(filter => (
            <button
              ...
              className={`px-6 py-2 rounded-full font-inter font-medium transition-colors border ${
                activeFilter === filter 
                  ? 'bg-teal-primary text-white border-teal-primary' 
                  : 'bg-beige text-dark-text border-sky-blue hover:border-teal-primary hover:text-teal-primary'
              }`}
            >
              {filter}
            </button>
